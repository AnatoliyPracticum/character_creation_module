"""Training project for docstring."""
...
def start_training(char_name: str, char_class: str) -> str:
    """Choose training and write result of training."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Choose caher class and write class description."""
